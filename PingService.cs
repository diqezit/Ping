    ...
    public class MainWindowEventHandler : IMainWindowHandler
    {
        ...
        public void HandleTraceRouteButtonClick()
        {
            if (string.IsNullOrWhiteSpace(_window.txtURL.Text))
                MessageBox.Show(FindResourceString(ERROR_NO_URL_KEY), FindResourceString("ErrorCaption"), MessageBoxButton.OK, MessageBoxImage.Warning);
            else
                HandleTraceWindow();
        }
        #endregion
        ...
        #region Trace Window Management
